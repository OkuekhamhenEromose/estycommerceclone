    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estyecomapp.cart')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estyecomapp.category')),
            ],
        ),
        migrations.CreateModel(
            name='CartProduct',
